...
class PageDashboard(BasePage):
    ...
    ts_select = (By.XPATH, '//*[@id="app"]/div/section/main/section/div[2]/div[2]/div/div/section/div[1]/div[2]/div/div/div[1]/div/div/input')
    ts_select_value = (By.XPATH, "/html/body/div[7]/div[1]/div[1]/ul/li[1]")
    ...
    leverage_select = (By.XPATH, '//*[@id="app"]/div/section/main/section/div[2]/div[2]/div/div/section/div[1]/div[2]/div/div/div[3]/div/div[1]/span/span/i')
    leverage_select_value = (By.XPATH, "/html/body/div[8]/div[1]/div[1]/ul/li[1]")
    ...
    note_input = (By.XPATH, '//*[@id="app"]/div/section/main/section/div[2]/div[2]/div/div/section/div[1]/div[2]/div/div/div[7]/div/input')
    submit_bt = (By.XPATH, '//button[text()="SUBMIT"]')
    add_live_expect_text = (By.XPATH, '//*[@id="app"]/div/section/main/section/div[2]/div[1]/div[2]/div[2]/div[3]/table/tbody/tr[2]/td[2]/div')
    ...
    add_demo_expect_text = (By.XPATH, '//*[@id="app"]/div/section/main/section/div[2]/div[1]/div[2]/div[4]/div[3]/table/tbody/tr[2]/td[2]/div')
    ...
    def add_live_account(self, trade_pwd, invest_pwd, note):
        ...
        self.log.info('点击【YES】按钮')

    def add_demo_account(self, pwd):
        self.find_element(*self.add_demo_account_bt).click()
    ...
    def get_add_live_tip(self):
        text = self.find_element(*self.add_live_expect_text).text
        return text

    def get_add_demo_tip(self):
        text = self.find_element(*self.add_demo_expect_text).text
        return text
